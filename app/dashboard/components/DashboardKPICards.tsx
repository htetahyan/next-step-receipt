    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="card-anthropic p-3.5 sm:p-4 flex flex-col justify-between transition-all hover:-translate-y-0.5 shadow-sm">
          ...
          <div className="flex items-center justify-between mt-3 pt-2 border-t border-[var(--card-border)] text-[11px] opacity-70 font-mono">
        ...
        <div className="card-anthropic p-3.5 sm:p-4 flex flex-col justify-between border border-emerald-500/20 bg-emerald-500/5 transition-all hover:-translate-y-0.5 shadow-sm">
          ...
          <div className="flex items-center justify-between mt-3 pt-2 border-t border-emerald-500/20 text-[11px] opacity-75 font-mono text-emerald-900 dark:text-emerald-200">
            <span>Formula</span>
