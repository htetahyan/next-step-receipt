        ...
        <div className="space-y-3 relative">
          ...
          {selectedCustomerId ? (
            ...
            <div className="relative">
              <div className="relative">
                <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 opacity-40 pointer-events-none" />
                <input
                  ref={inputRef}
                  type="text"
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
                  ...
                  {customerSearch && (
                    <button
                      ...
                      className="p-1 opacity-40 hover:opacity-80 rounded-full transition-opacity cursor-pointer"
                      title="Clear search"
                    >
