...
export default function Sidebar({ profile }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className="mobile-header h-14 w-full items-center justify-between border-b border-[var(--card-border)] bg-[var(--sidebar-bg)] px-4 shrink-0">
      ...
      {isMobileMenuOpen && (
        <div className="mobile-header fixed inset-0 z-50">
          <div
